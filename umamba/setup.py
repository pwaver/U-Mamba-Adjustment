...
setup(name='nnunetv2',
      ...
      install_requires=[
          ...
          "imagecodecs",
          "yacs",
          "monai>=1.4.0",  # 1.3.0 uses importer.find_module(), removed in Python 3.12
          "opencv-python"
      ],
      entry_points={
          'console_scripts': [
              ...
              'nnUNetv2_predict_with_model_exports = nnunetv2.inference.predict_from_raw_data_with_model_exports:predict_entry_point',
