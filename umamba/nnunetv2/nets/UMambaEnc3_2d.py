...
class ResidualMambaEncoder3(nn.Module):
    def __init__(self,
        ...
        for s in range(n_stages):
            ...
            if bool(s % 2) ^ bool(n_stages % 2):  ## guarantee the last stage has mamba layer
                mamba_layers.append(
                    MambaLayer3(dim=features_per_stage[s])
                )
            else:
...
class UMambaEnc3(nn.Module):
    def __init__(self,
        ...
        self.encoder = ResidualMambaEncoder3(
            input_size,
            input_channels,
            n_stages,
            features_per_stage,
...
def get_umamba_enc3_2d_from_plans(
    ...
    segmentation_network_class_name = 'UMambaEnc3'
    network_class = UMambaEnc3
    kwargs = {
        'UMambaEnc3': {
