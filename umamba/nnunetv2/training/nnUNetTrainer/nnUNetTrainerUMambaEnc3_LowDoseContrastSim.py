...
class nnUNetTrainerUMambaEnc3_LowDoseContrastSim(nnUNetTrainer_LowDoseContrastSim):
    @staticmethod
    def build_network_architecture(plans_manager: PlansManager,
        ...
        if len(configuration_manager.patch_size) == 2:
            ...
            raise NotImplementedError("UMambaEnc3 3D not yet implemented")
        else:
            raise NotImplementedError("Only 2D and 3D models are supported")

        print("UMambaEnc3_LowDoseContrastSim: {}".format(model))
