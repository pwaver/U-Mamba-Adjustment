...
class nnUNetTrainer_Loss_DiceFocal(nnUNetTrainer):
    ...
    def initialize(self):
        ...
        super().initialize()
        # self.loss = self._build_loss() # original. Everything is the same here except for the loss function for nnUNetTrainer
        # is changed to this next line.
        batch_dice=True
        self.loss = DC_and_Focal_loss({'batch_dice':batch_dice, 'smooth':1e-5, 
                                           'do_bg':False}, {'alpha':[1.,20.,20.], 'gamma':2., 'smooth':1e-5})
